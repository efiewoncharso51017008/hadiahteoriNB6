...
public abstract class HadiahTeori implements ActionListener {
    private static void createAndShowGUI(){
        JFrame frame = new JFrame("FROM"); frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        HadiahTeori app = new HadiahTeori(){};
    ...
    {
        label.setText("Efie Woncharso");
        label2.setText("51017008");
        label3.setText("Jl. Dg Regge lorong 3");
    }
